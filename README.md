...
1. Acessar automaticamente todos os arquivos PDF da pasta **Invoices**  
2. Classificar e processar as faturas com Document Understanding  
3. Extrair os seguintes campos:  
   * Invoice Number  
   * Billed To  
   * Due Date  
   * Amount Due  
4. Armazenar os dados extraídos em um arquivo Excel
...
3. Colocar os arquivos PDF de faturas na pasta:Invoices  
